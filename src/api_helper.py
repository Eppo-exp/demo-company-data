...
class EppoAPIHelper:
    ...
    def _get_entity_id_by_name(self, entity_name):
    ...
    def get_experiment_by_name(self, experiment_name: str, entity_name) -> Dict:
    ...
    def trigger_refresh(self, experiment_id, full_refresh=True):
        params = {
    ...
    def update_experiment(self, experiment_id, payload):
        """
